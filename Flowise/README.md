...
9.  Volte para o **Document Loader** do **$\textcolor{teal}{\textnormal{Flowise}}$**:
    ...
    2. Depois clique em `Upsert Chunks`.
        1. Onde está escrito **$\textcolor{pink}{\text{Select Embeddings}}$** selecione a opção escolhida no início (no meu caso foi o embedding do **Ollama**)
        ...
        2. Onde está escrito $\textcolor{yellow}{\text{Select Vector Store}}$ selecione o banco onde vai ser salvo o embedding dos dados (no meu caso será o **Qdrant**)
